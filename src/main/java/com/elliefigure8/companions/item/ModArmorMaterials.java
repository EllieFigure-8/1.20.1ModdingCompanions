...
public enum ModArmorMaterials implements ArmorMaterial {
    AURORITA("aurorita", 24, Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266655_) -> {
    ...
    }), 15, SoundEvents.ARMOR_EQUIP_NETHERITE, 3.0F, 0.1F, () -> Ingredient.of(ModItems.AURORITA_FRAGMENT.get()));
    ...
    public String getName() {
        return CompanionsMod.MOD_ID + ":" + this.name;
    }
